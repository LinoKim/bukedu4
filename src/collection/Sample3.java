...
public class Sample3 {
	public static void main(String[] args) {
		...
		s.add("orange");
		//s.add("apple");
		result=s.add("apple");	// 기존에 중복 데이터가 있어서 데이터가 입력되지 않은 경우 false 
		s.add(null);
		s.add("null"); /* 가급적 데이터 문자 null은 입력하지 마세요. 구별이 안됩니다. */ 
		//컴퓨터는 구별할 수 있지만 사용자는 못하기 때문임
		...
		List<String> L = new ArrayList<String>(s);	//생성자를 통해 set데이터를 전달하여 list 제작
